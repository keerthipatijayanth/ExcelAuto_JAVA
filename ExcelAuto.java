...
public class ExcelAuto {
	...
	public static void main(String[] args)throws FileNotFoundException, IOException {
		...
		data.put("2", new Object[] {1, "Naveen", "Kumar"});
		data.put("3", new Object[] {2, "Sai", "Jayanth"});
		data.put("4", new Object[] {3, "Praveen", "Kumar"});
		data.put("5", new Object[] {4, "Hemanth", "Muppala"});
        ...
        data1.put("2", new Object[] {1, "Naveen", "Kumar"});
        data1.put("3", new Object[] {2, "Sai", "Jayanth"});
        data1.put("4", new Object[] {3, "Praveen", "Kumar"});
        data1.put("5", new Object[] {4, "Hemanth", "Muppala"});
...
//						System.out.println(noMatch);
				...
				if(noMatch==0)
				{
					System.out.println("Hurray All Values Are Similar!!");
				}
				else
				{
